...
void print_help(char **tokens, int num_tokens) {
    if (num_tokens == 1) {
        general_help();
    ...
    } else if (!strcmp(tokens[1], "redirect")) {
        printf("help for 'redirect': \n");
        printf("\t- redirection is disabled on the windows build\n");
        ...
        printf("\t- currently both stdin and stdout cannot ");
        printf("be redirected at the same time\n");
    } else if (!strcmp(tokens[1], "prompt")) {
        ...
        printf("\t- on windows, only @pwd@ is enabled\n");
    } else if (!strcmp(tokens[1], "alias")) {
        ...
        printf("\t- included aliases:\n");
        printf("\t\t- alias rm 'rm -i'\n");
        printf("\t\t- alias cp 'cp -i'\n");
        printf("\t\t- alias mv 'mv -i'\n");
        printf("\t\t- alias .. 'cd ..'\n");
        printf("\t\t- alias v 'vim'\n");
        printf("\t\t- alias lz 'ls -lFGh'\n");
        printf("\t- commands must be surrounded by quotes\n");
        printf("\t- aliases are disabled by default, run with -a | --alias to use them\n");
        printf("\t- aliases are disabled permanently on the windows build.\n");
    } else if (!strcmp(tokens[1], "config")) {
        ...
        printf("\t- at startup, use -c or --config with optional parameter [FILE]\n");
        printf("\t- config files are not loaded by default\n");
        printf("\t- the config file to load on startup is stored in @config\n");
    } else if (!strcmp(tokens[1], "script")) {
        ...
        printf("\t\t- '-ne' or '--noexit'\n");
    } else if (!strcmp(tokens[1], "output")) {
    ...
    } else if (!strcmp(tokens[1], "builtins")) {
        ...
        printf("\t- the shell will exit afterwards, unless you use this option: \n");
        printf("\t\t- '-ne' or '--noexit'\n");
    } else if (!strcmp(tokens[1], "glob")) {
        printf("help for 'glob': \n");
        printf("\t- globbing enables you to use wildcard expressions with commands\n");
        printf("\t- globbing is disabled by default, use -g | --globbing to enable\n");
        printf("\t- globbing is permanently disable on the windows build\n");
    } else if (!strcmp(tokens[1], "pipes")) {
        printf("help for 'pipes': \n");
        printf("\t- pipes are under construction for unix\n");
        printf("\t- pipes will not be available for windows\n");
    } else {
